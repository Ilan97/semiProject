...
public class AlertExamLockedWindowController implements GuiController, Initializable {
	...
	public void start(Stage primaryStage) throws IOException {
		Parent root = FXMLLoader.load(getClass().getResource("/gui/AlertExamLockedWindow.fxml"));
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		Image img2 = new Image(this.getClass().getResource("lock.jpg").toString());
		imgLock.setImage(img2);
	}
}
// End of AlertExamLockedWindowController class