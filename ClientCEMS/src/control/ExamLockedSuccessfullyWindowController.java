...
/**
 * This is controller class (boundary) for window ExamLockedSuccessfully in
...
public class ExamLockedSuccessfullyWindowController implements GuiController, Initializable {
	...
	public void start(Stage primaryStage) throws IOException {
		Parent root = FXMLLoader.load(getClass().getResource("/gui/ExamLockedSuccessfullyWindow.fxml"));
