...
/**
 * This is controller class (boundary) for window RequestSendSuccessfully in
...
public class RequestSendSuccessfullyWindowController implements GuiController, Initializable {
	...
	public void start(Stage primaryStage) throws IOException {
		Parent root = FXMLLoader.load(getClass().getResource("/gui/RequestSendSuccessfullyWindow.fxml"));
