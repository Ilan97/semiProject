...
public class ShowExamInnerWindowController implements Initializable {
	...
	public void setQuestion(Question q, int index, int score, String ans) {
		...
		lblAns1Correct.setText("a. " + q.getRightAnswer());
		switch (ans) {
			case "0":
				lblAns2.setText("b. " + q.getWrongAnswer1());
				lblAns3.setText("c. "+ q.getWrongAnswer2());
				lblAns4.setText("d. " + q.getWrongAnswer3());
				break;
				
			case "1":
				lblAns2Wrong.setText("b. " + q.getWrongAnswer1());
				lblAns3.setText("c. " + q.getWrongAnswer2());
				lblAns4.setText("d. " + q.getWrongAnswer3());
				break;
			...
			case "2":
				lblAns2.setText("b. " + q.getWrongAnswer1());
				lblAns3Wrong.setText("c. " + q.getWrongAnswer2());
				lblAns4.setText("d. " + q.getWrongAnswer3());
				break;
			...
			case "3":
				lblAns2.setText("b. " + q.getWrongAnswer1());
				lblAns3.setText("c. " + q.getWrongAnswer2());
				lblAns4Wrong.setText("d. " + q.getWrongAnswer3());
				break;		
		}
	}
