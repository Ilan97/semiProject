...
/**
 * This is controller class (boundary) for window TeacherReportWasSaved. This
...
public class TeacherReportWasSavedWindowController implements GuiController, Initializable {
	...
	public void start(Stage primaryStage) throws IOException {
		Parent root = FXMLLoader.load(getClass().getResource("/gui/TeacherReportWasSavedWindow.fxml"));
...
//End of TeacherReportWasSavedWindowController class