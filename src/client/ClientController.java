...
public class ClientController extends AbstractClient {
	...
	public void handleMessageFromServer(Object msg) {
		...
		awaitResponse = false; // no longer wait for response from server (recieved message)
		...
		case "ExamController":
			...
			case "viewTableExam":
				exam = (Exam) messageFromServer.getMsg();
				break;

			case "updateExamDurationTime":
				exam.setDuration((int) messageFromServer.getMsg());
				break;
