...
public class ServerPortController {
	...
	/**
	 * static instance for ServerController instence. Will be create only once for
	 * each run.
	 */
	...
	@FXML
	public void refreshActionButton(ActionEvent event) throws UnknownHostException {
		// this list save the details of all connested clients
